...
SpecialVendingMachine model = new SpecialVendingMachine("Special Vending Machine");
MenuOptionsView menuOptionsView = new MenuOptionsView();
MenuOptionsController controller = new MenuOptionsController(model, menuOptionsView);
    }
}
